...
const StartSession = ({ item }) => {
  ...
  checkInStartTime.setHours(startHours);
  checkInStartTime.setMinutes(startMinutes - sessionCheckInBeforeStart);

  const checkInEndTime = new Date(sessionDate);
  checkInEndTime.setHours(startHours);
  checkInEndTime.setMinutes(startMinutes + sessionCheckInAfterStart);
